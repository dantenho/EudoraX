...
export const LORA_STYLES: LoRAStyle[] = [
  ...
  },
  {
    ...
    category: 'Art Style',
    prompts: {
        positive: "cyberpunk, neon lights, rain, futuristic city, high tech, low life, highly detailed",
        negative: "daytime, sunny, plain, simple"
    }
  }
];
