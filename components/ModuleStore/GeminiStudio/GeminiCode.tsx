...
/**
 * @file GeminiCode.tsx
 * @description Native Code Forge featuring a simulated Vim environment.
 * @runtime React 2026 (Concurrent Mode + Server Components)
 * @jules_hint Bind Esc key globally within the container to prevent focus loss.
 */
import React, { useState, useEffect, useRef } from 'react';
import { Icons } from '../../Icons';
import { Button } from '../../Button';

// Mock Prism for type safety in this snippet, actual import is via script tag in index.html
...
export default function NeuralComponent() {
  ...
  // Simulated React 2026 "Native Hook" for Vim keybindings
  useEffect(() => {
      ...
      <div className="flex-1 bg-[#1e1e1e] border border-white/5 rounded-[1rem] overflow-hidden flex flex-col shadow-2xl relative">
        ...
        <div className="flex-1 relative overflow-auto custom-scrollbar flex">
          ...
          <div className="flex-1 relative pt-4 pl-4 text-sm leading-6">
            ...
            {/* Input Overlay for Editing (Simplified) */}
            {mode === 'INSERT' && (
              <textarea
                ref={textareaRef}
        ...
        {/* Floating Command Palette if typing command */}
